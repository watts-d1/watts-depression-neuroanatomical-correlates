...
FEATURE_TRANSFER_RESULTS_PATH = "/path/to/deep_task_shallow_control_features_binary_classifier_significance.RData"  # Feature transfer classifier results
ORIGINAL_MODEL_RESULTS_PATH = "/path/to/deep_controls_binary_classifier_rfe_significance_residualized_covariates.RData"  # Original deep vs controls classifier results
...
# FALSE/FALSE (1188): Both models incorrectly classified these instances
# FALSE/TRUE (335): The feature transfer model misclassified, but the data-driven model correctly classified
# TRUE/FALSE (1517): The feature transfer model correctly classified, but the data-driven model misclassified
# TRUE/TRUE (23724): Both models correctly classified these instances
